...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('master.jenis_surat.update', $data->id) }}">
        @csrf

        <div class="mb-3">
            <label class="form-label">Nama Jenis Surat</label>
            <input type="text" name="nama_jenis" class="form-control" value="{{ old('nama_jenis', $data->nama_jenis) }}" required>
        </div>
